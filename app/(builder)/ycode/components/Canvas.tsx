...
import { getCanvasIframeHtml, updateViewportOverrides, measureContentExtent, injectStudioTheme, isNonContentLayer, getClippedLayerRect } from '@/lib/canvas-utils';
...
function CanvasContent({
  ...
  // The canvas always reflects authored App State defaults; interactive preview
  // runs in the separate preview iframe (PageRenderer), not here.
  ...
  // Seed the runtime store with authored defaults so LayerRenderer evaluates
  // visibility/styles against them.
  useEffect(() => {
